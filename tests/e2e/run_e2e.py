...
Usage:
    python claude/tests/e2e/run_e2e.py                     # run all
    python claude/tests/e2e/run_e2e.py --debug              # show raw output
    python claude/tests/e2e/run_e2e.py --discover           # dump first scenario
    python claude/tests/e2e/run_e2e.py --model haiku        # cheaper model
    python claude/tests/e2e/run_e2e.py --scenario "embedder"  # name filter
...
PLUGIN_DIR = Path(__file__).resolve().parent.parent.parent  # → claude/
